...
if __name__ == '__main__':
    func = ['(x+1/x)**2', 'math.exp(-x**2)', 'math.sqrt(1+x**2)', 'math.exp(x)*math.sin(x)/(1+x**2)', 'math.cos(-x**2/3)']
    a = [0.92, -0.981, 0.435, 0.659, 0.722]
    b = [1.92, 0.019, 1.435, 1.659, 1.722]
    order = [8, 8, 6, 6, 4]
    h = [1/2, 1/4, 1/3, 1/5, 1/3]
